        ...
        text = {
            LazyColumn {
                item {
                    ...
                    Text("Status:")
                    TextButton(onClick = { statusMenuExpanded = !statusMenuExpanded }) {
                        Text(text =  statusDescriptions[selectedStatus.value] ?: "Selecionar Status") // Exibe a descrição do status
                    }
                    DropdownMenu(
                ...
                item {
                    ...
                    Text("Nota:")
                    TextButton(onClick = { scoreMenuExpanded = !scoreMenuExpanded }) {
                        Text(text = "${selectedScore.value} - ${scoreDescriptions[selectedScore.value] ?: "Selecionar Nota"}") // Exibe a descrição da nota
                    }
                    DropdownMenu(
